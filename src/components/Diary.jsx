...
export function DiaryCard({ diaries, onOpen, onNewDiary, onViewAll, dark, textPrimary, bgPanel, borderColor }) {
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 8 }}>
        ...
        <span style={{ fontSize: 11.5, fontWeight: 800, color: textPrimary }}>My Diaries</span>
      </div>
        ...
        return (
          <div
            ...
            style={{
              ...
              gap: 9, marginBottom: 6, cursor: "pointer",
              transition: "all .15s", border: "1px solid transparent"
            }}
          >
            <div style={{ textAlign: "center", minWidth: 28 }}>
              <div style={{ fontSize: 17, fontWeight: 900, color: "#1a72c9", lineHeight: 1 }}>{parts[2] || "--"}</div>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 10, color: textPrimary, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
      ...
      <button
        ...
        style={{
          ...
          padding: 5, fontSize: 9.5, color: "#1a72c9", cursor: "pointer",
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 1, paddingLeft: 18 }}>
          ...
          <div
            ...
            style={{
              ...
              color: dark ? "#d4a050" : "#5a4030", marginBottom: 6,
          ...
          <textarea
            ...
            style={{
              fontFamily: "'Caveat',cursive", fontSize: 14.5, fontWeight: 600,
              color: dark ? "#c89848" : "#5a4030", background: "transparent",
              border: "none", outline: "none", resize: "none",
              width: "100%", minHeight: 175, lineHeight: 1.8
            }}
          />
        </div>
        ...
        {/* Large ghost date */}
        <div style={{
          position: "absolute", bottom: 10, right: 14, fontSize: 58, opacity: .055,
