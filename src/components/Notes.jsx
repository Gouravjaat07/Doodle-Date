/**
 * Right-panel notepad – shows a featured quote + bullet notes.
 * All state is lifted; parent owns `quote` and `notes`.
 */
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 1, paddingLeft: 6 }}>
          ...
          {notes.map((n, i) => (
            <div key={i} className="note-row">
              ...
              <textarea
                ...
                rows={1}
                style={{
                  fontSize: 10, color: textPrimary, lineHeight: 1.4, flex: 1,
                  background: "transparent", border: "none", outline: "none",
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: 9, color: "#bbb", padding: 0,
          ...
          <button
            ...
            onMouseOver={(e) => {
              e.target.style.background = "rgba(26,114,201,.08)";
              e.target.style.borderColor = "#1a72c9";
              e.target.style.color = "#1a72c9";
            }}
            onMouseOut={(e) => {
              e.target.style.background = "none";
              e.target.style.borderColor = "rgba(74,90,124,.45)";
              e.target.style.color = "#5a6a8a";
            }}
          >＋ Add note</button>
        </div>
      </div>
